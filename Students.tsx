    ...
    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
        {filteredStudents.map((student) => (
          <div key={student.id} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 md:p-6 hover:border-zinc-700 transition-all group relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-4 relative">
              ...
              <div className="relative">
                ...
                {openMenuId === student.id && (
                  <div 
                    ref={menuRef}
                    className="absolute right-0 mt-2 w-48 bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 origin-top-right"
                  >
                    <div className="py-1">
                      <button 
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4">
                <button 
                  ...
                  className="w-full sm:flex-1 px-6 py-3 rounded-xl border border-zinc-800 font-semibold hover:bg-zinc-800 transition-colors text-sm"
                >
                  Anuluj
                </button>
                <button 
