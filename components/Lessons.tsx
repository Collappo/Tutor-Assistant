              ...
              <div className="space-y-2">
                {groupedLessons[date].map((lesson) => {
                  ...
                  return (
                    <div
                      key={lesson.id}
                      className="bg-zinc-900   rounded-xl p-3 md:p-4 hover:border-zinc-700 transition-all group flex items-center gap-3 md:gap-4"
                    >
                      {/* Time & Duration */}
                      ...
                      <div className="relative">
                        ...
                        {openMenuId === lesson.id && (
                          <div
                            ref={menuRef}
                            className="absolute right-0 mt-2 w-44 bg-zinc-900   rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 origin-top-right"
                          >
                            {isPlanned && (
                              <button
